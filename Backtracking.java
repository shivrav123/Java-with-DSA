...
//find subsets  (we use string to add not string builder to append)
...
//             return;
//         }
//         //yes choice to be the part of the subset
//         findSubsets(str, ans + (str.charAt(i)), i + 1);
        
//         //no choice to be the part of the subset
